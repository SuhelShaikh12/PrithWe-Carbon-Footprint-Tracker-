...
// import express from "express";
// import bcrypt from "bcrypt";
// import db from "./db.js"; // default import for your pool
// import { sendOTP } from "./sendOTP.js";
...
//     // Optional: Check if already verified to prevent sending OTP again
//     if (userResult.rows[0].verified) {
//       return res.status(400).json({ message: "Email already verified" });
//     }

//     await sendOTP(normalizedEmail); // sendOTP updates OTP & timestamp
