...
// import "react-toastify/dist/ReactToastify.css";
// import { AiOutlineEyeInvisible, AiOutlineEye } from "react-icons/ai";
// import Logo from "../assets/google.png"; // Adjust the path if needed
...
//       if (response.data.sessionKey) {
//         // Store sessionKey in cookie (HttpOnly can't be set by JS, so this is just a cookie)
//         document.cookie = `sessionKey=${response.data.sessionKey}; path=/; Secure; SameSite=Strict`;
//         toast.success("Login successful!");
